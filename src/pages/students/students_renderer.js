//import {searchByBadgeNumberFnc} from './student_functions.js';
//const module1 = require('./student_functions.js');
...
searchButton.addEventListener('click', () => {
  searchByBadgeNumber();
  //searchByBadgeNumberFnc(document, window);
})
...
window.electronAPI.generateBadgeResult((result) => {
  ...
  setFormEnabled(document.getElementById('formStudentData'), false);
  if (result.error) {
    document.getElementById('badgeNumber').classList.remove("text-success");
    document.getElementById('badgeNumber').classList.add("text-danger");
    document.getElementById('badgeNumber_error').innerHTML = result.error;
    document.getElementById('badgeNumber_error').classList.remove("text-success");
    document.getElementById('badgeNumber_error').classList.add("text-danger");
  }
  else {
    document.getElementById('badgeNumber').classList.remove("text-danger");
    document.getElementById('badgeNumber').classList.add("text-success");
